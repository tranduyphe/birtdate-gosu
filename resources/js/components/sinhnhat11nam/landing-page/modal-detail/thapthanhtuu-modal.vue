    ...
    <div id="ThapThanhTuu-Modal">
      <!-- Nội dung modal ở đây -->
        <div class="tab-thanhtuu">
            <div
            class="nav flex-column nav-tabs border-0"
            id="v-tabs-tab"
            role="tablist"
            ...
            >
                <div class="nav-item mb-3">
                    ...
                    id="v-tabs-thu-thach-tab"
                    data-bs-toggle="tab"
                    href="#v-tabs-thu-thach"
                    role="tab"
                    aria-controls="v-tabs-thu-thach"
                    aria-selected="true"
                    >Bảng<br>thử thách</a>
                </div>
                ...
                <div class="nav-item mb-3">
                    <a
                    class="nav-link"
                    id="v-tabs-ky-tich-tab"
                    data-bs-toggle="tab"
                    href="#v-tabs-ky-tich"
                    role="tab"
                    aria-controls="v-tabs-ky-tich"
                    aria-selected="false"
                    >Chậu<br>kỳ tích</a>
                </div>
                ...
                <div class="nav-item mb-3">
                    <a
                    class="nav-link"
                    id="v-tabs-the-le-tab"
                    data-bs-toggle="tab"
                    href="#v-tabs-the-le"
                    role="tab"
                    aria-controls="v-tabs-the-le"
                    aria-selected="false"
                    >Thể lệ</a>
                </div>
                ...
                <div class="tab-content" id="v-tabs-tabContent">
                    ...
                    >
                        ...
                        <div class="task row justify-content-evenly">
                            <div v-for="(item, index) in quests" :key="index" class="item-task col-lg-5 d-flex align-items-center justify-content-between">
                                <span class="star" :style="{color: item.is_reward == 0 ? '#b2ad8a' : '#289e11'}">&#10022;</span>
                                <div class="item-info col-8">
                                    <p class="m-0">{{ item.name }}</p>
                                </div>
                                <div class="point">
                                    <p class="m-0" :style="{color: item.is_reward == 0 ? '#b2ad8a' : '#289e11'}">{{ item.current_attempts }}/{{ item.total_attempts }}</p>
                                </div>
                                <div class="item-button" v-if="item.is_reward == 0">
                                    <button class="btn p-0" @click="getReWard(item.type)"><img :src="iconBtn" title="Bấm vào đây để nhận thưởng"></button>
                    ...
                    <div
                        class="tab-pane fade lich-tuong-ky"
                        id="v-tabs-lich"
                        role="tabpanel"
                    ...
                    >
                        ...
                        <div class="task row justify-content-evenly">
                            <div v-for="(item, index) in logActivity" :key="index" class="item-task col-12 row justify-content-between text-center">
                    ...
                    <div
                        ...
                        id="v-tabs-the-le"
                        role="tabpanel"
                        aria-labelledby="v-tabs-the-le-tab"
                    >
                        <div class="title text-center">
...
.lich-tuong-ky .item-reason,.item-task .item-created-at{
    background: #edebdc;
}
</style>